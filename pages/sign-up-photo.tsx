...
export default function SignUpPhoto() {
    ...
    const onSubmit = async () => {
        ...
        data.append('phoneNumber', '08987284222');
            ...
            <form action="">
                <div className="form-input d-md-block d-flex flex-column">
                    <div>
                        <div className="mb-20">
                            <div className="image-upload text-center">
                                ...
                                {imagePreview ? <img src={imagePreview} className="image-upload" width={120} height={120} /> : <Image src="/img/upload.svg" width={120} height={120} />}
                                </label>
                                <input 
                                id="avatar" 
                                type="file" 
                    ...
                    <div className="button-group d-flex flex-column mx-auto">
                        ...
                        <Link href="/">
                        <a className="btn btn-tnc text-lg color-palette-1 text-decoration-underline pt-15" role="button">Terms & Conditions</a>
                        </Link>
