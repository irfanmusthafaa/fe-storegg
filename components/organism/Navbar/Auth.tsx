    ...
    if (isLogin){
        ...
        <div>
            ...
            <ul className="dropdown-menu border-0" aria-labelledby="dropdownMenuLink">
                ...
                <li><Link href="/"><a className="dropdown-item text-lg color-palette-2" href="#">Account Settings</a></Link></li>
                <li><Link href="/"><a className="dropdown-item text-lg color-palette-2" href="#">Log Out</a></Link></li>
            </ul>
        </div>
    </li>
        )
