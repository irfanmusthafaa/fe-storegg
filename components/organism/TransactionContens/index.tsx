import TableRow from "../../../pages/member/transactions/TableRow";
import ButtonTab from "./ButtonTab";


export default function TransactionContens() {
  return (
                ...
                <div className="row mt-30 mb-20">
                    <div className="col-lg-12 col-12 main-content">
                        <div id="list_status_title">
                            ...
                            <ButtonTab title="Sucess" active={false} />
                    ...
                    <div className="main-content main-content-table overflow-auto">
                        <table className="table table-borderless">
                            ...
                            <tbody id="list_status_item">
                                <TableRow image="overview-1.png" title="Mobile Legends:The New Battle 2023" category="Desktop" item={200} price={290000} status="Pending" />
